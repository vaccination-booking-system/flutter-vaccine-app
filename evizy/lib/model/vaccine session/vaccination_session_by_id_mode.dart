class VaccinationSessionByIdModel {
  String? timestamp;
  String? message;
  Data? data;

  VaccinationSessionByIdModel({this.timestamp, this.message, this.data});

  VaccinationSessionByIdModel.fromJson(Map<String, dynamic> json) {
