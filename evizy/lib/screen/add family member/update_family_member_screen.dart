...
class UpdateFamilyMemberScreen extends StatefulWidget {
  ...
  const UpdateFamilyMemberScreen(
      {Key? key,
      this.id,
      this.nik,
      this.name,
  ...
  @override
  State<UpdateFamilyMemberScreen> createState() =>
      _UpdateFamilyMemberScreenState();
}
...
class _UpdateFamilyMemberScreenState extends State<UpdateFamilyMemberScreen> {
  ...
  void initState() {
    ...
    _nomorController.text = widget.phoneNumber!;
    _tanggalController.text = widget.dateOfBirth!;
    dropdownHubungan = widget.relationship!;
    dropdownJenisKelamin = widget.gender!;
  }
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate() &&
                          ...
                          final bool isAvailable =
                              await updateFamilyMemberProvider
                                  .updateFamilyMember(
                            widget.id!,
